...
fn build_template() -> Vec<u8> {
    ...
    b.push_i16(280); b.push_i16(120); // cx, cy
    b.push_u16(0); // menu
    b.push_u16(0); // class
    ...
    b.push_u32(0);
    b.push_i16(7); b.push_i16(5); b.push_i16(260); b.push_i16(10);
    b.push_u16(0);
    ...
    b.push_u32(WS_CHILD | WS_VISIBLE);
    b.push_u32(0);
    b.push_i16(7); b.push_i16(20); b.push_i16(260); b.push_i16(10);
    b.push_u16(0);
    b.push_u16(0xFFFF); b.push_u16(0x0082);
    ...
    b.push_u32(0);
    b.push_i16(7); b.push_i16(33); b.push_i16(260); b.push_i16(14);
    b.push_u16(EDIT_WIN_DIR);
    b.push_u16(0xFFFF); b.push_u16(0x0081); // EDIT
    b.push_u16(0);
    b.push_u16(0);
    ...
    b.push_u32(WS_CHILD | WS_VISIBLE);
    b.push_u32(0);
    b.push_i16(105); b.push_i16(50); b.push_i16(60); b.push_i16(10);
    b.push_u16(0);
    b.push_u16(0xFFFF); b.push_u16(0x0082);
    b.push_str16("↕ 挂载映射");
    b.push_u16(0);
    ...
    b.push_u32(WS_CHILD | WS_VISIBLE);
    b.push_u32(0);
    b.push_i16(7); b.push_i16(63); b.push_i16(260); b.push_i16(10);
    b.push_u16(0);
    b.push_u16(0xFFFF); b.push_u16(0x0082);
    ...
    b.push_u32(WS_CHILD | WS_VISIBLE | WS_BORDER | WS_TABSTOP | ES_AUTOHSCROLL);
    b.push_u32(0);
    b.push_i16(7); b.push_i16(76); b.push_i16(260); b.push_i16(14);
    ...
    b.push_u32(0);
    b.push_i16(170); b.push_i16(98); b.push_i16(50); b.push_i16(14);
    b.push_u16(IDOK);
    ...
    b.push_u32(0);
    b.push_i16(225); b.push_i16(98); b.push_i16(50); b.push_i16(14);
    b.push_u16(IDCANCEL);
    b.push_u16(0xFFFF); b.push_u16(0x0080);
    b.push_str16("取消");
    b.push_u16(0);
...
unsafe extern "system" fn dialog_proc(
    ...
    match msg {
        WM_INITDIALOG => {
            ...
            // 设置 Windows 侧输入框
            let wide1: Vec<u16> = OsStr::new(&ctx.windows_dir).encode_wide().chain(once(0u16)).collect();
            windows_sys::Win32::UI::WindowsAndMessaging::SetDlgItemTextW(
                hwnd, EDIT_WIN_DIR as i32, wide1.as_ptr(),
            );

            // 设置容器侧输入框
            let wide2: Vec<u16> = OsStr::new(&ctx.container_dir).encode_wide().chain(once(0u16)).collect();
            windows_sys::Win32::UI::WindowsAndMessaging::SetDlgItemTextW(
                hwnd, EDIT_CONTAINER_DIR as i32, wide2.as_ptr(),
            );
            ...
            match id {
                IDOK => {
                    ...
                    let len1 = windows_sys::Win32::UI::WindowsAndMessaging::GetDlgItemTextW(
                        hwnd, EDIT_WIN_DIR as i32, buf.as_mut_ptr(), 512,
                    );
                    ...
                    let len2 = windows_sys::Win32::UI::WindowsAndMessaging::GetDlgItemTextW(
                        hwnd, EDIT_CONTAINER_DIR as i32, buf.as_mut_ptr(), 512,
                    );
